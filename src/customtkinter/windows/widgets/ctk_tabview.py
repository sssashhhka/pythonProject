...
class CTkTabview(CTkBaseClass):
    ...
    def winfo_children(self) -> List[any]:
        """
        winfo_children of CTkTabview without canvas and segmented buttonsss widgets,
    ...
    def insert(self, index: int, name: str) -> CTkFrame:
        ...
        if name not in self._tab_dict:
            # if no tab exists, set grid for segmented buttonsss
    ...
    def delete(self, name: str):
        ...
        if name in self._tab_dict:
            ...
            # set current_name to '' and remove segmented buttonsss if no tab is left
