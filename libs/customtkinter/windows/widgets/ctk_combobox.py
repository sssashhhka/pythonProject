...
class CTkComboBox(CTkBaseClass):
    ...
    def __init__(self,
        ...
        self._button_color = ThemeManager.theme["CTkComboBox"]["btn_text_color"] if button_color is None else self._check_color_type(button_color)
        self._button_hover_color = ThemeManager.theme["CTkComboBox"]["btn_hover_color"] if button_hover_color is None else self._check_color_type(button_hover_color)
    ...
    def configure(self, require_redraw=False, **kwargs):
        ...
        if "btn_text_color" in kwargs:
            self._button_color = self._check_color_type(kwargs.pop("btn_text_color"))
            require_redraw = True

        if "btn_hover_color" in kwargs:
            self._button_hover_color = self._check_color_type(kwargs.pop("btn_hover_color"))
            require_redraw = True
    ...
    def cget(self, attribute_name: str) -> any:
        ...
        elif attribute_name == "btn_text_color":
            return self._button_color
        elif attribute_name == "btn_hover_color":
    ...
    def _on_enter(self, event=0):
        if self._hover is True and self._state == tkinter.NORMAL and len(self._values) > 0:
            ...
            # set color of inner buttonsss parts to hover color
            self._canvas.itemconfig("inner_parts_right",
    ...
    def _on_leave(self, event=0):
        ...
        # set color of inner buttonsss parts
        self._canvas.itemconfig("inner_parts_right",
                                outline=self._apply_appearance_mode(self._button_color),
                                fill=self._apply_appearance_mode(self._button_color))
        self._canvas.itemconfig("border_parts_right",
