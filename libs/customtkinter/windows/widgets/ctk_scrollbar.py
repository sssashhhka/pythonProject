...
class CTkScrollbar(CTkBaseClass):
    ...
    def __init__(self,
        ...
        self._button_color = ThemeManager.theme["CTkScrollbar"]["btn_text_color"] if button_color is None else self._check_color_type(button_color)
        self._button_hover_color = ThemeManager.theme["CTkScrollbar"]["btn_hover_color"] if button_hover_color is None else self._check_color_type(button_hover_color)
